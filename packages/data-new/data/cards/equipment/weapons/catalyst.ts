 ...
 */
export const AThousandFloatingDreams = createCard(311104, ["character"])
  .setType("equipment")
 ...
 * （「法器」角色才能装备。角色最多装备1件「武器」）
 */
export const MagicGuide = createCard(311101, ["character"])
  .setType("equipment")
  .addTags("weaponCatalyst")
  .costSame(2)
  .buildToEquipment()
 ...
 * （「法器」角色才能装备。角色最多装备1件「武器」）
 */
export const SacrificialFragments = createCard(311102, ["character"])
  .setType("equipment")
  .addTags("weaponCatalyst")
  .costSame(3)
  .buildToEquipment()
 ...
 * （「法器」角色才能装备。角色最多装备1件「武器」）
 */
export const SkywardAtlas = createCard(311103, ["character"])
  .setType("equipment")
  .addTags("weaponCatalyst")
  .costSame(3)
  .buildToEquipment()
