 ...
 */
const EngulfingLightning = card(311405, "character")
  .costSame(3)
  .weapon("pole")
  // TODO
  .done();
 ...
 * （「长柄武器」角色才能装备。角色最多装备1件「武器」）
 */
const LithicSpear = card(311402, "character")
  .costSame(3)
  .weapon("pole")
  // TODO
  .done();
 ...
 * （「长柄武器」角色才能装备。角色最多装备1件「武器」）
 */
const Moonpiercer = card(311406, "character")
  .costSame(3)
  .weapon("pole")
  // TODO
  .done();
 ...
 * （「长柄武器」角色才能装备。角色最多装备1件「武器」）
 */
const SkywardSpine = card(311403, "character")
  .costSame(3)
  .weapon("pole")
  // TODO
  .done();
 ...
 * （「长柄武器」角色才能装备。角色最多装备1件「武器」）
 */
const VortexVanquisher = card(311404, "character")
  .costSame(3)
  .weapon("pole")
  // TODO
  .done();
 ...
 * （「长柄武器」角色才能装备。角色最多装备1件「武器」）
 */
const WhiteTassel = card(311401, "character")
  .costSame(2)
  .weapon("pole")
  // TODO
  .done();
