 ...
 * （「弓」角色才能装备。角色最多装备1件「武器」）
 */
const SacrificialBow = card(311202)
  .costSame(3)
  .weapon("bow")
  // TODO
  .done();
 ...
 * （「弓」角色才能装备。角色最多装备1件「武器」）
 */
const ElegyForTheEnd = card(311205)
  .costSame(3)
  .weapon("bow")
  // TODO
  .done();
